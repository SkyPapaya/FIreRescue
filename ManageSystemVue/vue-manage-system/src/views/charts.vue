<template>
  <div class="container" style="display: flex ; flex-wrap: wrap ; justify-content: space-between">
    ...
    <div id="area-chart" class="chart">
      <areaCharts style="width: 100% ; height: 100%"> 66</areaCharts>
    </div>

    <div id="environment-chart" class="chart">
      <environmentChart style="width: 100% ; height: 100%"> 66</environmentChart>
    </div>
    ...
    <div class="chart">
      <deviceChart style="width: 100% ; height: 100%">66</deviceChart>
    </div>
